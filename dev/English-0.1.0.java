...
public class English
{
  ...
  public String Execute( String Code, String OriginalCode )
  {
    ...
    if ( Code.indexOf( " of the " ) > -1 )
    {
      ...
      if ( HasVariable( a ) ) Code = Code.replace( " of the ", " of " );
    }
    ...
    switch( ParsedCode[ 0 ].toLowerCase() )
    {
      ...
      case "change":
        ...
        else if ( Code.indexOf( "'s" ) > -1 )
        {
          ...
          else
          {
            ...
            String VariableValue = Execute( Slice( ParsedCode, ParsedCode2.indexOf( "to" ) + 1, ParsedCode.length - 1 ) );
      ...
      case "sum":
      {
        ...
        String VariableA = ParseSentence( Slice( ParsedCode, 1, StartOfB - 1 ) );
        String VariableB = HasVariable( Slice( ParsedCode, StartOfB + 1, Until ) ) ? ParseSentence( Slice( ParsedCode, StartOfB + 1, Until ) ) : "0";
